...
Global $GUIWidth = 330, $GUIHeight = 120
...
Func _Main()
	...
	$hGUI = GUICreate("Clicker", $GUIWidth, $GUIHeight)
...
; ============================================================================
Func DoClick()
	_HideCursor($OCR_NORMAL)
	MouseClick("left", $PosTarget[0], $PosTarget[1], 1, 0)
	MouseMove($PosReturn[0], $PosReturn[1], 0)
	_RestoreCursor($OCR_NORMAL)
EndFunc
; ============================================================================
Func ShowHide()
